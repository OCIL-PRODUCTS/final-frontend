                  ...
                  <div id="chat-scroll">
                    <ul className="chat-list list-unstyled m-b-0">
                      <li className="clearfix active">
                        <img src="/assets/admin_assets/img/users/user-4.png" alt="avatar" />
                        <div className="about">
                      ...
                      <li className="clearfix">
                        <img src="/assets/admin_assets/img/users/user-2.png" alt="avatar" />
                        <div className="about">
                      ...
                      <li className="clearfix">
                        <img src="/assets/admin_assets/img/users/user-3.png" alt="avatar" />
                        <div className="about">
                      ...
                      <li className="clearfix">
                        <img src="/assets/admin_assets/img/users/user-5.png" alt="avatar" />
                        <div className="about">
