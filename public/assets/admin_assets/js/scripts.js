...
(function() {
  ...
  // Dynamically load jQuery if needed
  ...
  // Your original code, wrapped in an init function that receives jQuery as $
  function init($) {
...
$(function () {
  ...
  var sidebar_nicescroll;
    var update_sidebar_nicescroll = function () {
        if (sidebar_nicescroll && $.fn.niceScroll) {
          sidebar_nicescroll.resize();
        }
      };

  var sidebar_dropdown = function () {
        if ($(".main-sidebar").length && $.fn.niceScroll) {
...
// Kick things off
 function onJQReady($) {
  ...
  if (typeof jQuery === 'undefined') {
    loadScript('https://code.jquery.com/jquery-3.6.0.min.js', () => onJQReady(window.jQuery));
  } else {
    onJQReady(window.jQuery);
  }
})();